...
int main( )
{
    ...
    std::shared_ptr< AerodynamicCoefficientSettings > aerodynamicCoefficientSettings =
            constantAerodynamicCoefficientSettings(
                    referenceArea, aerodynamicDragCoefficient * Eigen::Vector3d::UnitX( ) );
