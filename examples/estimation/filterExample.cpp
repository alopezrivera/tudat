...
int main( )
{
    ...
    std::shared_ptr< IntegratorSettings< > > integratorSettings =
            std::make_shared< IntegratorSettings< > >
                    ( rungeKutta4, 0.0, timeStepSize );

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////            CONTROL AND FILTER SETTINGS              ///////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    auto extendedFilterSettings = std::make_shared< ExtendedKalmanFilterSettings< double, double > >(
                systemUncertainty,
                ...
                integratorSettings );
    auto unscentedFilterSettings = std::make_shared< UnscentedKalmanFilterSettings< double, double > >(
                systemUncertainty,
                measurementUncertainty,
                timeStepSize,
                initialTime,
    ...
    input_output::writeDataMapToTextFile( actualStateVectorHistory, "actualStateHistory.csv", tudat_applications::getOutputPath( "FilterEstimation" ) );
    ...
    input_output::writeDataMapToTextFile( extendedFilter->getEstimatedStateHistory( ),
                                          "EKFEstimatedStateHistory.csv", tudat_applications::getOutputPath( "FilterEstimation" ) );
    input_output::writeDataMapToTextFile( unscentedFilter->getEstimatedStateHistory( ),
                                          "UKFEstimatedStateHistory.csv", tudat_applications::getOutputPath( "FilterEstimation" ) );
    ...
    input_output::writeDataMapToTextFile( extendedFilter->getEstimatedCovarianceHistory( ),
                                          "EKFEstimatedCovarianceHistory.csv", tudat_applications::getOutputPath( "FilterEstimation" ) );
    input_output::writeDataMapToTextFile( unscentedFilter->getEstimatedCovarianceHistory( ),
                                          "UKFEstimatedCovarianceHistory.csv", tudat_applications::getOutputPath( "FilterEstimation" ) );
    ...
    input_output::writeMatrixToFile( systemNoise, "systemNoise.csv", 16, tudat_applications::getOutputPath( "FilterEstimation" ) );
    input_output::writeMatrixToFile( measurementNoise, "measurementNoise.csv", 16, tudat_applications::getOutputPath( "FilterEstimation" ) );
