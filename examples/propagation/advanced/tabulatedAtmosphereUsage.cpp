...
int main( )
{
    ...
    std::cout << "Example 1. ----------------------------------------------------------------------- " << std::endl;
    {
        ...
        std::string tabulatedAtmosphereFile = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphere.csv";
    ...
    std::cout << std::endl << "Example 2. ----------------------------------------------------------------------- " << std::endl;
    {
        ...
        tabulatedAtmosphereFiles[ 0 ] = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphereTimeAverage/density.csv";
        tabulatedAtmosphereFiles[ 1 ] = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphereTimeAverage/pressure.csv";
        tabulatedAtmosphereFiles[ 2 ] = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphereTimeAverage/temperature.csv";
        tabulatedAtmosphereFiles[ 3 ] = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphereTimeAverage/gasConstant.csv";
        tabulatedAtmosphereFiles[ 4 ] = paths::getAtmosphereTablesPath( ) + "/MCDMeanAtmosphereTimeAverage/specificHeatRatio.csv";
