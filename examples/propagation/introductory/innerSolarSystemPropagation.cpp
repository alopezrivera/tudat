...
int main( )
{
    ...
    int maxCentralBodySettings = 2;
    for( int centralBodySettings = 0; centralBodySettings < maxCentralBodySettings; centralBodySettings++ )
    {

        std::cout<< "Running Solar System propagations [" << centralBodySettings + 1 << "/" << maxCentralBodySettings << "]" <<std::endl;
        ...
        // Set central body as Solar System Barycenter for each body
        ...
        std::string outputSubFolder = "output_InnerSolarSystemPropagationExample/";

        std::cout<< "Saving simulation data: ";
        for( unsigned int i = 0; i < numberOfNumericalBodies; i++ )
        {
            // Write propagation history to file.
            std::cout<< bodyNames.at( i ) << "; ";
            input_output::writeDataMapToTextFile(
                        allBodiesPropagationHistory[ i ],
                        "innerSolarSystemPropagationHistory" + bodyNames.at( i ) +
                        boost::lexical_cast< std::string >( centralBodySettings ) + ".csv",
