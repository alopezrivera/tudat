...
int main( )
{
    ...
    std::cout << "Setting up acceleration model" << std::endl;
    ...
    std::cout << "Creating acceleration settings" << std::endl;
    ...
    std::cout << "Propagating Inner Solar System" << std::endl;
    ...
    std::string outputSubFolder = "output_InnerLongSolarSystemPropagationExample/";
    ...
    for( unsigned int i = 0; i < numberOfNumericalBodies; i++ )
    {
        ...
        input_output::writeDataMapToTextFile(
                ...
                "innerLongSolarSystemPropagationHistory" + bodyNames.at( i ) + ".csv",
